...
function addimg(city) {
  //var cityimg = document.getElementById("pics");
  //$("pics").empty();
  if(city=="Nanjing" || city =="Taipei"||city=="Changhua"
    ||city=="Kaohsiung"||city=="Taichung"||city=="Osaka"
    ||city=="Hualien"
    ){
    var x = document.createElement("IMG");
  x.setAttribute("src", "img/D.jpg");
  x.setAttribute("width", "304");

  x.setAttribute("alt", "city photo");
  //var cityimg=$("#pics");
  var cityimg = document.getElementById("pics");
  //src.appendChild(x);
    //document.body.appendChild(x);
    cityimg.appendChild(x);
    var head="img/";
    var tail=".jpg";

    var picsrc=head+city+tail;
    $("#pics").attr("src",picsrc);
    $("#pics").attr("height","200");
    $("#pics").attr("width","250");
  ...
  //src.appendChild(x);
    ...
    var head="img/";
    var tail=".jpg";
    console.log("^___________^"+city);
    var picsrc=head+city+tail;
    $("#pics").attr("src","img/C.jpg");
    $("#pics").attr("height","200");
    $("#pics").attr("width","250");
 //$("img").attr("src", "https://www.kasandbox.org/programming-images/animals/crocodiles.png");
}
   // var cityimg2=$("#pics2");
   // cityimg2.text("lebron");
    //cityimg2.appendChild(x);
     var body=$("body");
    var randomColor = Math.floor(Math.random()*16777215).toString(16);
    console.log("QQQQQQQQQQQQQQcolor:"+randomColor);
